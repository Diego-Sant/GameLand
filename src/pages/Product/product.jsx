...
const Product = () => {
  ...
  return (
    <div className='py-[20px] px-[50px] flex gap-[50px] bg-[#121212] flex-col lg:flex-row'>
      ...
      <div className='flex-[1] flex flex-col sm:flex-row gap-[20px] -ml-1 sm:-ml-0'>
        ...
        <div className='flex-[5] flex items-center'>
          <img className='w-[100%] max-w-[481px] min-w-[400px] sm:min-w-[481px] bg-cover' src={images[selectedImg]} alt="" />
        </div>
      </div>

    <div className='flex-[1] flex flex-col gap-[30px]'>
        <h1 className='text-4xl font-bold'>Rachet & Clank: Rift Apart</h1>
        ...
        <div className='flex items-center gap-2 font-[400] text-[16px] text-[#7b61ff]'>
          <FavoriteBorder className='cursor-pointer' />Lista de desejos
        </div>
        <div className='bg-[#1f1f1f] flex flex-col gap-[10px] text-gray-200 font-size[14px] p-3'>
          <div><span>Distribuidora:</span><Link className='text-[#7b61ff]'> Nintendo</Link></div>
          <div><span>Modo de jogador:</span><Link className='text-[#7b61ff]'> Um jogador</Link></div>
          <div><span>Gênero:</span>
            <Link className='text-[#7b61ff]'> Ação</Link>,
            <Link className='text-[#7b61ff]'> Aventura</Link>, 
            <Link className='text-[#7b61ff]'> RPG</Link>
          </div>
        </div>
      </div>
