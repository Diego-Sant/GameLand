      ...
      <>
        <div className='flex-[1] flex flex-col sm:flex-row gap-[20px] -ml-1 sm:-ml-0'>
          <div className='flex-[1] flex justify-center items-center flex-wrap gap-x-10 sm:gap-x-0 sm:flex-col'>
            ...
            {data?.attributes?.img3?.data?.attributes?.url ? <img className='w-[100%] max-w-[120px] min-w-[120px] h-[120px] object-cover cursor-pointer mb-[10px] hover:brightness-90' src={process.env.REACT_APP_UPLOAD_URL + data?.attributes?.img3?.data?.attributes?.url} alt={data?.attributes?.title} onClick={(e) => setSelectedImg("img3")} /> : ""}
            {data?.attributes?.img4?.data?.attributes?.url ? <img className='w-[100%] max-w-[120px] min-w-[120px] h-[120px] object-cover cursor-pointer mb-[10px] hover:brightness-90' src={process.env.REACT_APP_UPLOAD_URL + data?.attributes?.img4?.data?.attributes?.url} alt={data?.attributes?.title} onClick={(e) => setSelectedImg("img4")} /> : ""}
            {data?.attributes?.img5?.data?.attributes?.url ? <img className='w-[100%] max-w-[120px] min-w-[120px] h-[120px] object-cover cursor-pointer mb-[10px] hover:brightness-90' src={process.env.REACT_APP_UPLOAD_URL + data?.attributes?.img5?.data?.attributes?.url} alt={data?.attributes?.title} onClick={(e) => setSelectedImg("img5")} /> : ""}
          </div>
